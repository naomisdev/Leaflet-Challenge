...
function circleSize(feature){
  ...
  radius = magSize**3  ///magSize^3 cubed
  ...
  L.geoJSON(data, {
    ...
    pointToLayer: function(feature, latlng) {
      return new L.CircleMarker(latlng, {
        radius: circleSize (feature),    //5    //radius(magnitude)
        fillOpacity: 1
      })
    }, 
      style: function(feature) {
        return {
        	color: colorCode(feature)
        };
    }
...
legend.onAdd = function (mapgdgd) {

    var div = L.DomUtil.create('div', 'info legend'),    //<div class = "info legend">loop1, loop2
        grades = [0, 2, 10],
